...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p fe03110a-e9e1-4fe3-b1c8-ed8db7946e0a
```

> `fe03110a-e9e1-4fe3-b1c8-ed8db7946e0a` is the password of the certificate, you can change it to any password you want.
...
The application needs a database. Run the following command in the `AbpBlazorSolution` directory to migrate the database and seed the initial data. This step is automatically done when you create a new solution, if you didn't especially disabled it.
