...
namespace AbpBlazorSolution.Menus;

public class AbpBlazorSolutionMenuContributor : IMenuContributor
{
    ...
    {
        var l = context.GetLocalizer<AbpBlazorSolutionResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                AbpBlazorSolutionMenus.Home,
                l["Menu:Home"],
                "/",
                icon: "fas fa-home",
                order: 1
